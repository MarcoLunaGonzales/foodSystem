...
$sql_detalle="select cod_salida_almacen, cod_material, cantidad_unitaria, lote, fecha_vencimiento
...
{	$codVenta=$dat_detalle[0];
	...
	if($cantidadSalidaPivote>0){
		...
		i.ingreso_anulado='0' and id.cod_material='$codMaterial' and id.lote='$loteMaterial' order by saldo desc";
