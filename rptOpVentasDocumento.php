...
{	var rpt_territorio,fecha_ini, fecha_fin, rpt_ver;
	...
	window.open('rptVentasDocumento.php?rpt_territorio='+rpt_territorio+'&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+'&variableAdmin='+variableAdmin,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,width=1000,height=800');			
	return(true);
}
</script>
<?php
...
echo"<form method='get' action='rptVentasDocumento.php' target='_BLANK'>";
